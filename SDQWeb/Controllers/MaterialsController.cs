...
namespace SDQWeb.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LectureSlide,VideoLink,PresentationFile,Notes")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LectureSlide,VideoLink,PresentationFile,Notes")] Material material)
        {
            if (ModelState.IsValid)
            {
