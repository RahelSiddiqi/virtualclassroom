...
namespace SDQWeb.Controllers
{
    public class NotesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,UserId")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,UserId")] Note note)
        {
            if (ModelState.IsValid)
            {
